const config = {
  ...
  color_palette: ['#FF5733','#0C090A','#3B3131','#504A4B','#52595D','#708090','#4863A0','#2B547E','#2B3856','#151B8D','#2916F5','#1589FF','#77BFC7','#66CDAA','#46C7C7','#3EA99F','#008B8B','#045F5F','#34A56F','#728C00','#808000','#12AD2B','#36F57F','#F2BB66','#F4A460','#C19A6B','#C2B280','#E9AB17','#C88141','#7F462C','#8B4513','#C34A2C','#B5651D','#CC6600','#FF5F1F','#E67451','#CD5C5C','#F62217','#B21807','#7D0541','#810541','#F660AB','#FF1493','#CA226B','#D462FF','#4E5180','#5E5A80','#7B68EE','#DC143C'],
  ...
  color_range: ["#ff7e5f", "#feb47b","#feb47b","#fef47b","#0f7f5f", "#aef47b","#aee4ab","#fea4fb","#aabf7b","#00bf7b","#0000fb","#0f07bf","#0abf7b","#00bf7b","#0000fb","#0f07bf"],
